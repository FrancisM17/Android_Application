...
public class ProfileAdapter extends BaseAdapter {
    ...
    public void OnCreate(Bundle savedInstanceState){
        spinn = (Spinner) findViewById(R.id.spinner2);
        adapterSpin = new ArrayAdapter<String>(this,android.R.layout.simple_spinner_dropdown_item, AppBase.divisions);
        assert spinn != null;
        spinn.setAdapter(adapterSpin);
