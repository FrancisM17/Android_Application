...
//        notificationIntent.putExtra(MainListAdapter.IS_EMERGENCY, true);
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(activity.getBaseContext())
                .setTicker("Ticker Title").setContentTitle("Check Available Notes!")
    ...
    public View getView(int position, View v, ViewGroup parent) {
        ...
        if (names.get(position).toString().equals("ATTENDANCE")) {
            imageView.setImageResource(R.drawable.ic_action_att);
            ...
            imageView.setImageResource(R.drawable.ic_action_sch);
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
            ...
            imageView.setImageResource(R.drawable.ic_action_no);
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
            ...
            Animation anim = new ScaleAnimation(
                    0.95f, 3f, // Start and end values for the X axis scaling
                    0.95f, 3f, // Start and end values for the Y axis scaling
                    Animation.RELATIVE_TO_SELF, 0.5f, // Pivot point of X scaling
                    Animation.RELATIVE_TO_SELF, 0.5f); // Pivot point of Y scaling
            anim.setFillAfter(true); // Needed to keep the result of the animation
            anim.setDuration(2000);
            ...
            imageView.setImageResource(R.drawable.ic_action_pro);
            v.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ...
                    .setPositiveButton("Enter", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            if (cursor == null || cursor.getCount() == 0) {
                                ...
                                launchinIntent.putExtra("PERIOD", hour.getText().toString().replaceAll(".","-"));
